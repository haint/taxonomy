 ...
 *
 */
class ModelIndexFactory extends AbstractFactory<Index>
{
   public ModelIndexFactory() {
      super();
      INSTANCE = new ModelIndexFactory();
   }
    ...
    */
   @Override
   public Index getModelById(String id) throws Exception
   {
    ...
    */
   @Override
   public List<Index> getModelsFromRange(int from, int to) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public List<Index> getModelsFromRange(int from, int to, String orderBy,
    ...
    */
   @Override
   public Index insert(Index model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Index update(Index model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Index delete(Index model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
