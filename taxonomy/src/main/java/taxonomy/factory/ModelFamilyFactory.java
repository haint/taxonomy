 ...
 *
 */
class ModelFamilyFactory extends AbstractFactory<Family>
{
   public ModelFamilyFactory() {
      super();
      INSTANCE = new ModelFamilyFactory();
   }
    ...
    */
   @Override
   public Family getModelById(String id) throws Exception
   {
    ...
    */
   @Override
   public List<Family> getModelsFromRange(int from, int to) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public List<Family> getModelsFromRange(int from, int to, String orderBy,
    ...
    */
   @Override
   public Family insert(Family model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Family update(Family model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Family delete(Family model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
