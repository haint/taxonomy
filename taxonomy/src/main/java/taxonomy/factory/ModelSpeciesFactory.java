 ...
 *
 */
class ModelSpeciesFactory extends AbstractFactory<Species>
{
   public ModelSpeciesFactory() {
      super();
      INSTANCE = new ModelSpeciesFactory();
   }
    ...
    */
   @Override
   public Species getModelById(String id) throws Exception
   {
    ...
    */
   @Override
   public List<Species> getModelsFromRange(int from, int to) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public List<Species> getModelsFromRange(int from, int to, String orderBy,
    ...
    */
   @Override
   public Species insert(Species model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Species update(Species model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Species delete(Species model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
