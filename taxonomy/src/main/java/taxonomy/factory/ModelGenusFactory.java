 ...
 *
 */
class ModelGenusFactory extends AbstractFactory<Genus>
{
   
   public ModelGenusFactory() {
      super();
      INSTANCE = new ModelGenusFactory();
   }
    ...
    */
   @Override
   public Genus getModelById(String id) throws Exception
   {
    ...
    */
   @Override
   public List<Genus> getModelsFromRange(int from, int to) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public List<Genus> getModelsFromRange(int from, int to, String orderBy,
    ...
    */
   @Override
   public Genus insert(Genus model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Genus update(Genus model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
    ...
    */
   @Override
   public Genus delete(Genus model) throws Exception
   {
      // TODO Auto-generated method stub
      return null;
   }
