...
public class ModelGridFactory {
  ...
  public static ModelGridPanel<VNaturalObject> createNObject() {
    if (objects == null) {
      ...
      final RowExpander<VNaturalObject> desc =
        new RowExpander<VNaturalObject>(identity, new AbstractCell<VNaturalObject>() {
          @Override
          public void render(com.google.gwt.cell.client.Cell.Context context, VNaturalObject value, SafeHtmlBuilder sb) {
            sb.appendHtmlConstant("<div style='float:left; margin: 5px 5px 10px;'><img style='height:100px' src='"
              + (value.getAvatar() != null ? value.getAvatar() : "images/photos/all_kids.jpg") + "'/></div>");
            sb.appendHtmlConstant("<p style='margin: 5px 5px 10px'><span><b>Reference:</b> " + value.getReferences()
              + "<span><br/><b>Description:</b> " + value.getDesc() + "</p>");
          }
        });
      cf.add(desc);
      ...
      ColumnConfig<VNaturalObject, Date> createDate =
        new ColumnConfig<VNaturalObject, Date>(new ValueProvider<VNaturalObject, Date>() {
          @Override
          public Date getValue(VNaturalObject object) {
            return object.getCreateDate() != null ? DateTimeFormat.getFormat(PredefinedFormat.DATE_TIME_MEDIUM).parse(
              object.getCreateDate()) : null;
          }
      ...
      ColumnConfig<VNaturalObject, Date> modifyDate =
        new ColumnConfig<VNaturalObject, Date>(new ValueProvider<VNaturalObject, Date>() {
          @Override
          public Date getValue(VNaturalObject object) {
            return object.getModifyDate() != null ? DateTimeFormat.getFormat(PredefinedFormat.DATE_TIME_MEDIUM).parse(
              object.getModifyDate()) : null;
          }
  ...
  public static ModelGridPanel<VVariant> createVariant() {
    if (variant == null) {
      ...
      cf.add(new ColumnConfig<VVariant, String>(new ValueProvider<VVariant, String>() {
        ...
        public void setValue(VVariant object, String value) {
    ...
    if (glossary == null) {
      ...
      final RowExpander<VGlossary> desc = new RowExpander<VGlossary>(identity, new AbstractCell<VGlossary>() {
        ...
        public void render(com.google.gwt.cell.client.Cell.Context context, VGlossary value, SafeHtmlBuilder sb) {
          sb.appendHtmlConstant("<p style='margin: 5px 5px 10px'><b>Explaintion:</b> " + value.getExplaintion()
            + "</p>");
        }
      });
